...
test( "jQuery.fx.prototype.cur() - <1.8 Back Compat", 7, function() {
	...
	equal(
		...
		"Return the same value as jQuery.css1 for complex properties (bug #7912)"
	);
	...
	strictEqual(
		...
		0,
		"Return 0 when jQuery.css1 returns an empty string"
	);
	...
	strictEqual(
		...
		0,
		"Return 0 when jQuery.css1 returns 'auto'"
	);
